...
export default function ViewConatacts() {
  ...
  const getAllContacts = async () => {
    try {
      setIsLoading(true);
      await FormService.getContacts("", rowsPerPage, currentpage, "").then(
        (res: AxiosResponse) => {
  ...
  const deleteContact = async (id: string) => {
    try {
      await FormService.deleteContact(id).then((res: AxiosResponse) => {
        getAllContacts();
