...
export default function Home() {
  return (
    <div className="row flex-nowrap color-effect w-100 cs-mt-4" style={{minHeight:"550px"}}>
      {/* <div
...
<section className="hero">
      <div className="intro-text text-left">
        <h1>
          <span className="hear border-bottom-3 border-danger"> Ideas Coupled with Action </span> <br />
          <span className="connecting ">         We Design, 
        <br />
        Develop Intelligent Systems and Simulate them too. </span>
       </h1>
        <Link className="btn text-black" to="about" style={{color:"black"}}>Read More...</Link>
